# youtube: i promaker programacion orientada a objetos en python
...
def modificarNotas():
    ...
    cedula = int(input("Ingrese el numero de cedula a buscar:"))
    for objAlumno in listadoEstudiantes:
        if cedula == objAlumno.cedula:
            nota1 = float(input("Ingrese nota 1:"))
            nota2 = float(input("Ingrese nota 2:"))
            nota3 = float(input("Ingrese nota 3:"))
...
def consultarHistorial():
    print("Consulta de Historia\n")
    cedula = (input("Ingrese el numero de cedula a buscar:"))
    for objAlumno in listaEstudiantes:
        if cedula == objAlumno.cedula:
